...
def exit_early(msg, myConfig, sev):
    ...
    if today > (last_success + interval + threshold):
        ...
        suffix = "Exiting early, but !BACKUP IS OVERDUE!, will check again in " + str(myConfig.retry_when_overdue_days)+ " day(s) (" + str(next_action) + ")"
    else:
        next_action = today + datetime.timedelta(days=myConfig.retry_days)
        suffix = "Exiting early, will check again in " + str(myConfig.retry_when_overdue_days)+ " day(s) (" + str(next_action) + ")"
